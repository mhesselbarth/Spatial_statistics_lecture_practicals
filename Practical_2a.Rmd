...
```{r}
  ...
  Oest <- function(input, correction = "Ripley", r = NULL, divisor = "d", ...){
    
    p_fct <- pcf.ppp(input, correction = correction, r = r, divisor = divisor, ...)
...
```{r, fig.align = "center"}
  quantum_plot(simulation_envelope_199, 
               xlab = "r [m]", ylab = "O(r)",
