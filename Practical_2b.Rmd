...
```{r, message = FALSE, warning = FALSE, results = "hide"}
  simulation_envelope_random_labeling <- envelope(douglas_fir_ppp, 
                                                  fun = pcfcross, i = "alive", j = "dead", 
...
```{r, echo = FALSE,  fig.align = "center"}
  plot(simulation_envelope_random_labeling, xlim = c(0, 45), 
...
```{r}
  douglas_fir <- read_delim(file = "DouglasFir_Adult_vs_Seedling_OGN.txt", delim = ";")
...
```{r}
Oest_cross <- function(input,i,j, correction = "Ripley", r = NULL, divisor = "d", ...){
...
```{r,  message = FALSE, warning = FALSE, results = "hide"}
  antecedent_conditions <- envelope(douglas_fir_ppp, fun = Oest_cross, 
