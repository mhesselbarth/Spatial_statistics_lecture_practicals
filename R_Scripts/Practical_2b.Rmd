...
```{r, echo = FALSE,  fig.align = 'center'}
  # par(mfrow=c(1,2))
  plot(envelope_hardcore, xlim=c(0,45), legend = FALSE, main="Univariate O-ring statistic \nhard-core process")
  plot(envelope_softcore,xlim=c(0,45), legend = FALSE, main="Univariate O-ring statistic \nsoft-core process")
  # par(mfrow=c(1,1))
```
...
for(i in 1:199){
  seedlings <- subset.ppp(douglas_fir_ppp, marks=="seedlings", drop=T)
  adults <- subset(douglas_fir_ppp, marks=="adults", drop=T)
...
```{r, echo = FALSE, fig.align = 'center'}
  plot(antecedent_conditions, xlim = c(0, 45),
       legend = FALSE, main = "Bivariate O-ring statistic \nantecedent conditions")
```
