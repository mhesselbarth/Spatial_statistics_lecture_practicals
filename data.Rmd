...
You can choose if you prefer using [_Programita_](http://programita.org) or [_R_](https://www.r-project.org) to work on the practicals. Anyways, for the following plenum discussions, I suggest taking screenshots of the results for each exercise.
