...
```{r model_parameter, collapse = TRUE}
...
## Exercise 1 
__Task:__ The data set *Alive_DouglasFir_OGN.txt* contains the location and stem diameters (diameter at breast height, DBH) for all live Douglas fir trees in the Old-growth North plot. Calculate the mark correlation function What do these results suggest?
...
```{r, echo = FALSE, fig.align = "center"}
  plot(subset.ppp(hemlock_ppp, marks == "adults", drop = TRUE), main="Hemlock \nadults")
```
...
```{r}
  Oest <- function(input, correction = "Ripley", r = NULL, divisor = "d", ...){
    ...
    p_fct <- pcf(input, correction = correction, r = r, divisor = divisor, ...)
